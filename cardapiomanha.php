...
$sql = "SELECT terca_cardapio FROM cardapio WHERE id_cardapio =1"; 
$res = mysqli_query($con,$sql);
$terca_cardapio = mysqli_fetch_assoc($res);

$sql = "SELECT quarta_cardapio FROM cardapio WHERE id_cardapio =1"; 
$res = mysqli_query($con,$sql);
$quarta_cardapio = mysqli_fetch_assoc($res);

$sql = "SELECT quinta_cardapio FROM cardapio WHERE id_cardapio =1"; 
$res = mysqli_query($con,$sql);
$quinta_cardapio = mysqli_fetch_assoc($res);

$sql = "SELECT sexta_cardapio FROM cardapio WHERE id_cardapio =1"; 
$res = mysqli_query($con,$sql);
...
<body>
      ...
      <div id="container">
        <div id="linha-vertical"></div>
            <h1 class="titulo">CARDÁPIO DA MANHÃ MONDRONE</h1>
